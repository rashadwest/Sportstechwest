#!/usr/bin/env python3
"""
n8n Wrapper Script for Netlify Deployment Status Check
...
try:
    from monitor_builds import get_netlify_status_json
except ImportError:
    ...
    get_netlify_status_json = monitor_builds.get_netlify_status_json

def main():
    """Main function - outputs JSON for n8n."""
    try:
        result = get_netlify_status_json()
