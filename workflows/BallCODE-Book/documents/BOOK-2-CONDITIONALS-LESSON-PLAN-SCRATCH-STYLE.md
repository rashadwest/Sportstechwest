...
│ MOVE FORWARD        │
├─────────────────────┤
│ IF DEFENDER NEAR    │  (Orange C-shaped block)
...
- Try: IF DEFENDER NEAR → THEN CROSSOVER → ELSE DRIVE
...
3. Use: IF DEFENDER NEAR → THEN CROSSOVER → ELSE DRIVE
...
**Success Criteria:**
- ✅ Conditional has IF, THEN, ELSE
- ✅ Condition makes sense (DEFENDER NEAR)
- ✅ Player reacts correctly
- ✅ Student can explain the conditional
...
**Exercise Completion:**
- ✅ Created conditional (IF, THEN, ELSE)
- ✅ Conditional works (player reacts)
- ✅ Can explain conditional
