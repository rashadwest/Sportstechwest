...
### Step 3: Execute
* When the condition is right → Take the highest-value shot (layup if available (1.20 PPP)→ corner 3 if available (1.16 PPP) → Top of the Key 3 Pointer → etc. Deviate when you have other options that make sense for your situation or personel.
