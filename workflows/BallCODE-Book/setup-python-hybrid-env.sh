...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}🐍 Python Hybrid n8n Workflow - Environment Setup${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
echo -e "${BLUE}📁 Detected Workflow Path:${NC} $WORKFLOW_PATH"
echo ""
...
if [ ! -f "$WORKFLOW_PATH/scripts/n8n-check-github.py" ]; then
    echo -e "${RED}❌ Missing: scripts/n8n-check-github.py${NC}"
    MISSING_SCRIPTS=1
else
    echo -e "${GREEN}✅ Found: scripts/n8n-check-github.py${NC}"
fi

if [ ! -f "$WORKFLOW_PATH/scripts/n8n-check-netlify.py" ]; then
    echo -e "${RED}❌ Missing: scripts/n8n-check-netlify.py${NC}"
    MISSING_SCRIPTS=1
else
    echo -e "${GREEN}✅ Found: scripts/n8n-check-netlify.py${NC}"
fi

if [ ! -f "$WORKFLOW_PATH/scripts/monitor-builds.py" ]; then
    echo -e "${RED}❌ Missing: scripts/monitor-builds.py${NC}"
    MISSING_SCRIPTS=1
else
    echo -e "${GREEN}✅ Found: scripts/monitor-builds.py${NC}"
fi

if [ $MISSING_SCRIPTS -eq 1 ]; then
    echo ""
    echo -e "${RED}❌ Missing required Python scripts. Please ensure all scripts are present.${NC}"
    exit 1
fi
...
if python3 "$WORKFLOW_PATH/scripts/n8n-check-github.py" 2>&1 | grep -q '"status"'; then
    echo -e "${GREEN}✅ n8n-check-github.py outputs valid JSON${NC}"
else
    echo -e "${YELLOW}⚠️  n8n-check-github.py test inconclusive (credentials may be missing)${NC}"
fi

if python3 "$WORKFLOW_PATH/scripts/n8n-check-netlify.py" 2>&1 | grep -q '"status"'; then
    echo -e "${GREEN}✅ n8n-check-netlify.py outputs valid JSON${NC}"
else
    echo -e "${YELLOW}⚠️  n8n-check-netlify.py test inconclusive (credentials may be missing)${NC}"
fi
echo ""
...
echo -e "${GREEN}✅ Created: .n8n-hybrid-env${NC}"
echo ""

# Display n8n configuration instructions
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}📋 n8n Environment Variables to Set${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}Go to n8n UI → Settings → Environment Variables${NC}"
echo ""
