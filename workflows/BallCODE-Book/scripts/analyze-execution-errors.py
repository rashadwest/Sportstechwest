...
def main():
    ...
    print()
    print("=" * 70)
    print("📋 Step-by-Step Error Analysis")
    print("=" * 70)
    print()
    ...
    print()
    print("=" * 70)
    print("🔧 Quick Fixes Based on Error Type")
    print("=" * 70)
    print()
    print("If error is 'Credential not found' or 'OpenAI API key missing':")
    print("  → Add OpenAI credential in n8n Credentials")
    print("  → Assign to 'Message a model' node")
    print()
    print("If error is 'environment variable is not set':")
    print("  → Add env vars in Settings → Environment Variables")
    print("  → Restart n8n")
    print()
    print("If error is 'Cannot read property' or 'TypeError':")
    print("  → Check Code node for null/undefined access")
    print("  → Add null checks")
    print()
    print("If error is 'Invalid input' or 'Missing required field':")
    print("  → Check input data format")
    print("  → Verify previous nodes output correct data")
    print()
    print("=" * 70)
    ...
    print("  → Likely: Same error repeating")
    print("  → Check Exec 85 (most recent) for exact error")
    print()
    print("Unity Build Orchestrator: 1 failure, 2 successes (intermittent)")
    print("  → Likely: Environment variable issue (sometimes set, sometimes not)")
    print("  → Or: Conditional logic issue")
    print("  → Check Exec 79 for exact error")
    print()
