---
layout: post
title: "I Have Called Myself a Translator for Years. Sports Is Finally Seeing Why It Matters."
description: "Sports does not have a data shortage. It has a translation gap. Why athlete-informed analytics translators turn numbers and film into cues coaches and players can use."
permalink: /blog/i-have-called-myself-a-translator-for-years/
thumbnail: "/assets/images/blog-img/translator-analytics-hero.png"
badge_color: "text-bg-primary"
trending: true
simple_nav: true
date: 2026-07-21
tags: [analytics, basketball, coaching, translation, sportstechwest, ballcode, player-development]
categories: [Insights]
author: "Rashad West"
---
...
The tools have changed. The job has remained the same.

Turn complexity into understanding. Then turn understanding into action.

I wrote about this role in 2020, when I called Sportstechwest an analytics translator. The title was not a marketing line waiting for a trend. It was a description of the gap I kept seeing between measurement and meaning.

Sports is starting to talk more openly about that gap. Good. The need has been there longer than the language.

---

## The Real Problem Is Not More Data

Organizations now have more dashboards, more automated clips, more sensor outputs, and more ways to grade a possession than most staffs can absorb in a week.

College programs also operate inside regulated time. Under [NCAA Division I Bylaw 17.1.7.1](https://web3.ncaa.org/lsdbi/reports/pdf/searchPdfView?businessCode=BYLAW_SEARCH_VIEW&id=1567), countable athletically related activities in the playing season are limited to a maximum of four hours per day and twenty hours per week. That constraint matters. Every film session, meeting, and tech walkthrough competes with practice, recovery, and the rest of a student-athlete’s life.
...
A translator is not someone who makes analytics less intelligent.

A translator protects the intelligence while making its meaning usable for a specific audience.

An analyst may see a statistically meaningful pattern. A coach may see a tactical problem. A player may hear criticism.

The translator’s job is to preserve what is true while changing how it is communicated.
...
<div class="text-center my-4">
  <img src="https://sportstechwest.com/assets/images/blog-img/translator-analytics-terms.png?v=20260723d" alt="The Translation System: Translator, Hoop Tendency Experts, BallCODE, and BallCODEChess" class="img-fluid">
</div>
...
That is not watering down analytics.

It is completing the work.

---

## How the Translator Role Was Built

I did not arrive at this work from a single job title.

I played professional basketball outside the NBA. That experience matters because information feels different when you are the one who has to run it in a live possession. A number that looks clean on a slide can feel like noise if nobody connects it to your reads, your timing, or your role.
...
Each stage looked different on paper. The skill was the same.
...
A small number of relevant clips.
...
The exact number of clips will vary by athlete and situation. The larger principle is to reduce unnecessary information and make the intended action unmistakable.
...
Assistant coaches do not all need to become programmers or data scientists.

They need enough technological and analytical literacy to ask the right questions, recognize what matters, challenge misleading conclusions, translate output into basketball language, deliver it in a way that fits the athlete, and connect the message to practice and competition.
...
Analysts protect the measurement. Hoop Tendency Experts help the organization use it. When those roles respect each other, the staff gets both confidence in the number and clarity in the cue.
...
If a possession can teach conditional logic, a dashboard can teach a parent what efficiency actually means, and a film clip can teach a player one read to try tomorrow.

Same bridge. Different rooms.

---

## The Gap I Keep Working to Close

Technology will continue giving teams more footage, more measurements, and more ways to evaluate performance.

But information alone does not teach.
...
I translate the game.

Related: [SportsTechWest the Analytics Translator (2020)](/blog/SportsTechWest-the-Analytics-Translator/)

- Rashad West | Sportstechwest
